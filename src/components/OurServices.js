    ...
    <div>
      ...
      <div className="service-container">
        <div className="service-item">
          <FontAwesomeIcon icon={faDesktop} size="2x" fw="5px" className='icons1'/>
        ...
        <div className="service-item">
          <FontAwesomeIcon icon={faGlobe} size="2x" className='icons1' />
        ...
        <div className="service-item">
          <FontAwesomeIcon icon={faServer} size="2x" className='icons1'/>
